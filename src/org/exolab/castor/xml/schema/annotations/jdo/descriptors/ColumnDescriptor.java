...
public class ColumnDescriptor extends org.exolab.castor.xml.schema.annotations.jdo.descriptors.ReadonlyDirtyTypeDescriptor {
    ...
    public ColumnDescriptor() {
        ...
        //-- type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "type", "type", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object ) 
        ...
        desc.setValidator(fieldValidator);
        //-- acceptNull
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Boolean.TYPE, "acceptNull", "acceptNull", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object ) 
                throws IllegalStateException
            {
                ...
                return (target.getAcceptNull() ? Boolean.TRUE : Boolean.FALSE);
            }
            @Override
            public void setValue( Object object, Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setAcceptNull( ((Boolean) value).booleanValue());
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: acceptNull
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
