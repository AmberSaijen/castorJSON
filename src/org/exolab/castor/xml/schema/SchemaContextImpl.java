...
public class SchemaContextImpl implements SchemaContext {
   ...
   * {@inheritDoc}
   * 
   * @see SchemaContext#getSchemaResolver()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.castor.xml.InternalContext#getParser(String)
   */
   ...
   * {@inheritDoc}
   * 
   * @see SchemaContext#setSchemaResolver(Resolver)
   */
