...
public class Sql implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<String> _name;
     ...
     *  
     */
    private java.util.List<String> _manyKey;
    ...
    public Sql() {
        super();
        this._name = new java.util.ArrayList<String>();
        this._manyKey = new java.util.ArrayList<String>();
     ...
     * collection
     */
    public java.util.Enumeration<? extends String> enumerateManyKey(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<? extends String> enumerateName(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends String> iterateManyKey(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends String> iterateName(
    ) {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (Sql) org.exolab.castor.xml.Unmarshaller.unmarshal(Sql.class, reader);
    }
