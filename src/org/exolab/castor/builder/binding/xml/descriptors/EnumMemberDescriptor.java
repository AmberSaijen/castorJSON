...
public class EnumMemberDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EnumMemberDescriptor() {
        ...
        //-- value
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "value", "value", org.exolab.castor.xml.NodeType.Element);
        ...
        //-- javaName
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "javaName", "javaName", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    EnumMember target = (EnumMember) object;
                    target.setJavaName( (String) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
