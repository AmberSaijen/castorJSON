...
public class ExcludeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ExcludeDescriptor() {
        ...
        //-- className
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "className", "class-name", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
