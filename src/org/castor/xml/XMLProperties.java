...
public class XMLProperties extends AbstractProperties {
  ...
  //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    public static final String MEMBER_NAME_CAPITALISATION_STRICT = "true";
    /**
     ...
     * the name of a class which extends {@link JavaNaming}.
     * 
     * Possible values:
     * - null
     * - A class name (which extends {@link JavaNaming}).
     * 
     * <pre>
     ...
     */
      ...
      * @since 1.0
      */
     public static final String ANNOTATION_PROCESSOR = 
         "org.jsoncast.annotation.processor";
